# Spell Review — Coordination Table

Original coordination table listing every event in the 2-week Spell Review cycle
with responsible party, description, and deadline.

| Responsible | Event | Deadline |
|-------------|-------|----------|
